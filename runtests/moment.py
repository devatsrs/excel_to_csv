...
class tz(object):
    ...
    def __init__(self, dt, zonelabel="UTC"):
        ...
        if isinstance(dt, datetime):
            ...
            raise TypeError(
                "'dt' should be a datetime object or a numeric type")
...
class Zone(object):
    ...
    def __init__(self, zonelabel):
        ...
        self.name = zonelabel
        # In ms. We omit the trailing None value.
        self.untils = zone_data.untils[:-1]
...
TZ_UTC = tzinfo('UTC')
# Same as EPOCH, but an "aware" instance.
EPOCH_UTC = EPOCH.replace(tzinfo=TZ_UTC)
